...
class DocuvitaDocument < ApplicationRecord
  ...
  DOCUMENT_TYPES = %w[isometry_pdf rt_image vt_image pt_image on_hold_image qr_code material_certificate_pdf delivery_note_pdf visual_check_image vt2_check_image pt2_check_image rt_check_image].freeze
